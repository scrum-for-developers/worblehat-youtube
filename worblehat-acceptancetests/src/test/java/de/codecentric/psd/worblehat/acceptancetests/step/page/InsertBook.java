...
public class InsertBook {
    ...
    public void whenABookWithISBNisbnIsAdded(String title, String author, String edition, String year, String isbn) {
        insertAndSubmitBook(title, author, edition, year, "", isbn);
    }

    @When("a librarian adds a book with title {string}, author {string}, edition {string}, year {string}, description {string} and isbn {string}")
    public void whenABookIsAdded(String title, String author, String edition, String year, String description,
            String isbn) {
    ...
    public void whenASimilarBookIsAdded(String title, String author, String edition) {
        ...
        insertAndSubmitBook(title, author, edition, String.valueOf(lastInsertedBook.getYearOfPublication()),
                lastInsertedBook.getDescription(), lastInsertedBook.getIsbn());
    }
    ...
    public void pageContainsErrorMessage(String field) {
        String errorMessage = seleniumAdapter
                .getTextFromElement(("isbn".equals(field) ? PageElement.ISBN_ERROR : PageElement.EDITION_ERROR));
    ...
    private void insertAndSubmitBook(String title, String author, String edition, String year, String description,
            String isbn) {
    ...
    private void fillInsertBookForm(String title, String author, String edition, String isbn, String year,
            String description) {
