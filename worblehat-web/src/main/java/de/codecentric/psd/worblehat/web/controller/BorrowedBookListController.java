...
public class BorrowedBookListController {
  ...
  @PostMapping
  public String findBorrowedBooksByEmailAddress(
      @ModelAttribute("returnAllBookFormData") @Valid ReturnAllBooksFormData returnAllBooksFormData,
      BindingResult result,
      ModelMap modelMap) {
    List<Borrowing> borrowings =
        bookService.findAllBorrowingsByEmailAddress(returnAllBooksFormData.getEmailAddress());
